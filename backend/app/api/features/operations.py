...
def build_router(runtime):
    return build_feature_router(runtime, [
        ...
        ("GET", "/api/ops/skills/stats", "ops_skill_stats"),
        ...
        ("GET", "/api/ops/records", "list_ops_records"),
        ("GET", "/api/ops/records/export", "export_ops_records"),
        ("DELETE", "/api/ops/records/{job_id}", "delete_ops_record"),
